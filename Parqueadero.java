...
public class Parqueadero {
    ...
    public void avanzarHora() {
        ...
        if (horaActual == 21){
            // Se indica que ya cerramos el parqueadero
            abierto = false;
        }
    }
    ...
    public String metodo1() {
        // Obtener la placa del carro que lleva más tiempo en el parqueadero
        String placaMenor = "";
        int menorHora = 100;
        ...
        for (Puesto puesto: puestos) {
            if (puesto.estaOcupado()){
                ...
                if (carro.darHoraLlegada() < menorHora) {
                    menorHora = carro.darHoraLlegada();
                    placaMenor = carro.darPlaca();
                }
            }
        }
        return placaMenor;
